...
public class Rational {
    ...
    public Rational add(Rational other) {
        ...
        Rational sum = new Rational((this.x * other.y) + (this.y * other.x),
                this.y * other.y);
        return sum;
    }
    ...
    public Rational multiply(Rational other) {
        ...
        Rational product = new Rational(this.x * other.y, this.y * other.x);
        return product;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.x == ((Rational) other).x && this.y == ((Rational) other).y) {
            return true;
        }
        return false;
    }
